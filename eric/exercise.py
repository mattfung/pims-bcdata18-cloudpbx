...
# f1 = df[ df["a_mos_f1_mult10"]/10 <= 3 | df["a_mos_f2_mult10"]/10 <= 3  df["b_mos_f1_mult10"]/10 <= 3  df["b_mos_f2_mult10"]/10 <= 3 |
# df["a_mos_adapt_mult10"]/10 <= 3 |
# f6 = df[ df["b_mos_adapt_mult10"]/10 <= 3 ]
...
f1['a_mos_f2_mult10'] = f1['a_mos_f2_mult10'].fillna(0)
f1['b_mos_f1_mult10'] = f1['b_mos_f1_mult10'].fillna(0)
f1['b_mos_f2_mult10'] = f1['b_mos_f2_mult10'].fillna(0)
